...
fn main() -> Result<ExitCode> {
    ...
    let bindings = vec![
        ...
        (KeyModifiers::ALT, KeyCode::Enter, Action::AcceptSelectedItems),
        ...
        (KeyModifiers::CONTROL, KeyCode::Char('t'), Action::SortModified),
        (KeyModifiers::ALT, KeyCode::Char('t'), Action::SetTarget),
